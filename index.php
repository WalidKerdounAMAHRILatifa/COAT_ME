...
<body class="animsition">
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs2-slick1">
			<div class="slick1">
				<div class="item-slick1 bg-overlay1" style="background-image: url(images/slide-05.jpg);" data-thumb="images/thumb-01.jpg" data-caption="Vêtements des Femmes">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								<span class="ltext-202 txt-center cl0 respon2">
								 Collection des Femmes 2020
								</span>
							</div>
				...
				<div class="item-slick1 bg-overlay1" style="background-image: url(images/slide-06.jpg);" data-thumb="images/thumb-02.jpg" data-caption="Vêtements des Hommes">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rollIn" data-delay="0">
								<span class="ltext-202 txt-center cl0 respon2">
									Nouvelle saisons des Hommes
								</span>
							</div>
	...
	<section class="bg0 p-t-23 p-b-130">
		<div class="container">
			...
			require_once('database.php');
			$result = $conn->prepare("SELECT * FROM produit ORDER BY id_Produit ASC LIMIT 8");
			$result->execute();
